    ...
    const handleReturn = (id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios.delete(`https://assignment-11-server-site-m9nxszv8b-jubayer-ahmed-sajid.vercel.app/borrowings/${id}`)
                .then((res)=>{
        ...
        <div className="card  glass">
            ...
            <div className="card-body">
                ...
                <div className="card-actions justify-center">
                    ...
                    <button onClick={() => handleReturn(_id)} className="btn bg-secondary  border-none ">Return</button>
                </div>
            </div>
        </div>
    )
